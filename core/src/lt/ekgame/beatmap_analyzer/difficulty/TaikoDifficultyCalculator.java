...
public class TaikoDifficultyCalculator implements DifficultyCalculator {
	...
	public TaikoDifficulty calculate(Mods mods, Beatmap beatmap) {
		...
		Array<TaikoObject> hitObjects = bm.getHitObjects();
		Array<DifficultyObject> objects = generateDifficultyObjects(hitObjects, timeRate);
		Array<Double> strains = calculateStrains(objects, timeRate);
		Array<Double> strainsOriginal = new Array<>(strains);
	...
	static class DifficultyObject {
		...
		private final TaikoObject object;
