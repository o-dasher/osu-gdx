...
public class ReusableTextureManager {
    ...
    public Texture getTexture(FileHandle file, ReusableTextureListener listener) {
        return getTexture(file, false, listener);
    }

    public Texture getTexture(@NotNull FileHandle file, boolean useMipMaps, ReusableTextureListener listener) {
